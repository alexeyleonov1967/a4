...
public class GroupCreationTests2 {
    ...
    public void setUp() throws Exception {
        ...
        wd.manage().timeouts().implicitlyWait(1250, TimeUnit.SECONDS);
    ...
    private void fillGroupForm() {
        ...
        wd.findElement(By.name("group_name")).sendKeys("x1_test1");
        ...
        wd.findElement(By.name("group_header")).sendKeys("x2_test2");
        wd.findElement(By.name("group_footer")).click();
        wd.findElement(By.name("group_footer")).clear();
        wd.findElement(By.name("group_footer")).sendKeys("x3_test3");
    }
