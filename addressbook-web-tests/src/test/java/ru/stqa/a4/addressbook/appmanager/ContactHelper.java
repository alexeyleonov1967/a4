...
public class ContactHelper extends BaseHelper {
  ...
  public void fillContactForm(ContactData contactData) {
    ...
    isSelectedClick("//div[@id='content']/form/select[1]//option[2]");
    ...
    isSelectedClick("//div[@id='content']/form/select[1]//option[3]");
    //if (!wd.findElement(By.xpath("//div[@id='content']/form/select[1]//option[3]")).isSelected()) {
    //  click(By.xpath("//div[@id='content']/form/select[1]//option[3]"));
    //}

    isSelectedClick("//div[@id='content']/form/select[1]//option[4]");
    ...
    isSelectedClick("//div[@id='content']/form/select[1]//option[5]");
    ...
    isSelectedClick("//div[@id='content']/form/select[1]//option[6]");
    ...
    isSelectedClick("//div[@id='content']/form/select[1]//option[7]");
    ...
    // Месяц рожденья   сентябрь
    isSelectedClick("//div[@id='content']/form/select[2]//option[1]");
    ...
    isSelectedClick("//div[@id='content']/form/select[2]//option[2]");
    //if (!wd.findElement(By.xpath("//div[@id='content']/form/select[2]//option[2]")).isSelected()) {
    //  click(By.xpath("//div[@id='content']/form/select[2]//option[2]"));
    //}

    isSelectedClick("//div[@id='content']/form/select[2]//option[3]");
    ...
    isSelectedClick("//div[@id='content']/form/select[2]//option[4]");
    ...
    isSelectedClick("//div[@id='content']/form/select[2]//option[5]");
    ...
    isSelectedClick("//div[@id='content']/form/select[2]//option[6]");
    ...
    isSelectedClick("//div[@id='content']/form/select[2]//option[7]");
    ...
    isSelectedClick("//div[@id='content']/form/select[2]//option[8]");
    ...
    isSelectedClick("//div[@id='content']/form/select[2]//option[9]");
    ...
    isSelectedClick("//div[@id='content']/form/select[2]//option[10]");
    ...
    //Число и месяц юбилея   2 марта 1950 года
    isSelectedClick("//div[@id='content']/form/select[3]//option[1]");
    isSelectedClick("//div[@id='content']/form/select[3]//option[2]");
    isSelectedClick("//div[@id='content']/form/select[3]//option[3]");
    isSelectedClick("//div[@id='content']/form/select[3]//option[4]");
    //isSelectedClick("//div[@id='content']/form/select[3]//option[4]");
    isSelectedClick("//div[@id='content']/form/select[4]//option[1]");
    isSelectedClick("//div[@id='content']/form/select[4]//option[2]");
    isSelectedClick("//div[@id='content']/form/select[4]//option[3]");
